...
Friend Class lpsolve55
  ...
  Public Declare Function add_column Lib "lpsolve55.dll" Alias "add_column" (ByVal lp As Integer, ByRef column As Double) As Boolean
  Public Declare Function add_columnex Lib "lpsolve55.dll" Alias "add_columnex" (ByVal lp As Integer, ByVal count As Integer, ByRef column As Double, ByRef rowno As Integer) As Boolean
  Public Declare Function add_constraint Lib "lpsolve55.dll" Alias "add_constraint" (ByVal lp As Integer, ByRef row As Double, ByVal constr_type As lpsolve_constr_types, ByVal rh As Double) As Boolean
  Public Declare Function add_constraintex Lib "lpsolve55.dll" Alias "add_constraintex" (ByVal lp As Integer, ByVal count As Integer, ByRef row As Double, ByRef colno As Integer, ByVal constr_type As lpsolve_constr_types, ByVal rh As Double) As Boolean
  Public Declare Function add_lag_con Lib "lpsolve55.dll" Alias "add_lag_con" (ByVal lp As Integer, ByRef row As Double, ByVal con_type As lpsolve_constr_types, ByVal rhs As Double) As Boolean
  Public Declare Function add_SOS Lib "lpsolve55.dll" Alias "add_SOS" (ByVal lp As Integer, ByVal name As String, ByVal sostype As Integer, ByVal priority As Integer, ByVal count As Integer, ByRef sosvars As Integer, ByRef weights As Double) As Integer
  Public Declare Function column_in_lp Lib "lpsolve55.dll" Alias "column_in_lp" (ByVal lp As Integer, ByRef column As Double) As Integer
  ...
  Public Declare Function get_basis Lib "lpsolve55.dll" Alias "get_basis" (ByVal lp As Integer, ByRef bascolumn As Integer, ByVal nonbasic As Boolean) As Boolean
  ...
  Public Declare Function get_column Lib "lpsolve55.dll" Alias "get_column" (ByVal lp As Integer, ByVal col_nr As Integer, ByRef column As Double) As Boolean
  Public Declare Function get_columnex Lib "lpsolve55.dll" Alias "get_columnex" (ByVal lp As Integer, ByVal col_nr As Integer, ByRef column As Double, ByRef nzrow As Integer) As Integer
  ...
  Public Declare Function get_constr_value Lib "lpsolve55.dll" Alias "get_constr_value" (ByVal lp As Integer, ByVal row As Integer, ByVal count As Integer, ByRef primsolution As Double, ByRef nzindex As Integer) As Double
  Public Declare Function get_constraints Lib "lpsolve55.dll" Alias "get_constraints" (ByVal lp As Integer, ByRef constr As Double) As Boolean
  Public Declare Function get_dual_solution Lib "lpsolve55.dll" Alias "get_dual_solution" (ByVal lp As Integer, ByRef rc As Double) As Boolean
  ...
  Public Declare Function get_lambda Lib "lpsolve55.dll" Alias "get_lambda" (ByVal lp As Integer, ByRef lambda As Double) As Boolean
  ...
  Public Declare Function get_primal_solution Lib "lpsolve55.dll" Alias "get_primal_solution" (ByVal lp As Integer, ByRef pv_Renamed As Double) As Boolean
  Public Declare Function get_print_sol Lib "lpsolve55.dll" Alias "get_print_sol" (ByVal lp As Integer) As Integer
  Public Declare Function get_PseudoCosts Lib "lpsolve55.dll" Alias "get_PseudoCosts" (ByVal lp As Integer, ByRef clower As Double, ByRef cupper As Double, ByRef updatelimit As Integer) As Boolean
  ...
  Public Declare Function get_row Lib "lpsolve55.dll" Alias "get_row" (ByVal lp As Integer, ByVal row_nr As Integer, ByRef row As Double) As Boolean
  Public Declare Function get_rowex Lib "lpsolve55.dll" Alias "get_rowex" (ByVal lp As Integer, ByVal row_nr As Integer, ByRef row As Double, ByRef colno As Integer) As Integer
  ...
  Public Declare Function get_sensitivity_obj Lib "lpsolve55.dll" Alias "get_sensitivity_obj" (ByVal lp As Integer, ByRef objfrom As Double, ByRef objtill As Double) As Boolean
  Public Declare Function get_sensitivity_objex Lib "lpsolve55.dll" Alias "get_sensitivity_objex" (ByVal lp As Integer, ByRef objfrom As Double, ByRef objtill As Double, ByRef objfromvalue As Double, ByRef objtillvalue As Double) As Boolean
  Public Declare Function get_sensitivity_rhs Lib "lpsolve55.dll" Alias "get_sensitivity_rhs" (ByVal lp As Integer, ByRef duals As Double, ByRef dualsfrom As Double, ByRef dualstill As Double) As Boolean
  ...
  Public Declare Function get_variables Lib "lpsolve55.dll" Alias "get_variables" (ByVal lp As Integer, ByRef var As Double) As Boolean
  ...
  Public Declare Function guess_basis Lib "lpsolve55.dll" Alias "guess_basis" (ByVal lp As Integer, ByRef guessvector As Double, ByRef basisvector As Integer) As Boolean
  ...
  Public Declare Function is_feasible Lib "lpsolve55.dll" Alias "is_feasible" (ByVal lp As Integer, ByRef values As Double, ByVal threshold As Double) As Boolean
  ...
  Public Declare Function read_freeMPS Lib "lpsolve55.dll" Alias "read_freeMPS" (ByVal filename As String, ByVal verbose As Integer) As Integer
  ...
  Public Declare Function read_MPS Lib "lpsolve55.dll" Alias "read_MPS" (ByVal filename As String, ByVal verbose As Integer) As Integer
  ...
  Public Declare Function set_basis Lib "lpsolve55.dll" Alias "set_basis" (ByVal lp As Integer, ByRef bascolumn As Integer, ByVal nonbasic As Boolean) As Boolean
  ...
  Public Declare Function set_column Lib "lpsolve55.dll" Alias "set_column" (ByVal lp As Integer, ByVal col_no As Integer, ByRef column As Double) As Boolean
  Public Declare Function set_columnex Lib "lpsolve55.dll" Alias "set_columnex" (ByVal lp As Integer, ByVal col_no As Integer, ByVal count As Integer, ByRef column As Double, ByRef rowno As Integer) As Boolean
  ...
  Public Declare Function set_obj_fn Lib "lpsolve55.dll" Alias "set_obj_fn" (ByVal lp As Integer, ByRef row As Double) As Boolean
  Public Declare Function set_obj_fnex Lib "lpsolve55.dll" Alias "set_obj_fnex" (ByVal lp As Integer, ByVal count As Integer, ByRef row As Double, ByRef colno As Integer) As Boolean
  ...
  Public Declare Function set_PseudoCosts Lib "lpsolve55.dll" Alias "set_PseudoCosts" (ByVal lp As Integer, ByRef clower As Double, ByRef cupper As Double, ByRef updatelimit As Integer) As Boolean
  ...
  Public Declare Sub set_rh_vec Lib "lpsolve55.dll" Alias "set_rh_vec" (ByVal lp As Integer, ByRef rh As Double)
  Public Declare Function set_row Lib "lpsolve55.dll" Alias "set_row" (ByVal lp As Integer, ByVal row_no As Integer, ByRef row As Double) As Boolean
  ...
  Public Declare Function set_rowex Lib "lpsolve55.dll" Alias "set_rowex" (ByVal lp As Integer, ByVal row_no As Integer, ByVal count As Integer, ByRef row As Double, ByRef colno As Integer) As Boolean
  ...
  Public Declare Function set_var_weights Lib "lpsolve55.dll" Alias "set_var_weights" (ByVal lp As Integer, ByRef weights As Double) As Boolean
  ...
  Private Function GetEnvironmentVariable(ByRef name As String) As String
    Dim l As Integer
    Dim buf As String
